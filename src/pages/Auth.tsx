...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 bg-background relative overflow-hidden">
      {/* Brand panel */}
      <div className="hidden md:flex flex-col justify-between p-12 bg-sidebar text-sidebar-foreground relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-transparent pointer-events-none" />
        <div className="z-10">
          <div className="flex items-center gap-3">
            <img src="/app-icon.png" alt="Logo" className="w-10 h-10 rounded-xl object-cover shadow-sm" />
            <span className="text-2xl font-bold tracking-tight">AkiliCash</span>
          </div>
        </div>
        <div className="space-y-4 max-w-md z-10">
          <h2 className="text-5xl font-bold leading-tight min-h-[60px]">
            <TypewriterEffect />
          </h2>
        ...
        <p className="text-xs text-sidebar-foreground/50 uppercase tracking-widest font-medium z-10">Join the unified credit network.</p>
      </div>

      {/* Form panel */}
      <div className="flex items-center justify-center p-6 relative">
        {/* Decorative elements */}
        <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] rounded-full bg-primary/5 blur-3xl pointer-events-none" />
        ...
        >
          <Card className="p-8 shadow-elegant border-muted/50 bg-card/80 backdrop-blur-xl">
            <div className="md:hidden flex items-center mb-8 gap-3 justify-center">
              <img src="/app-icon.png" alt="Logo" className="w-8 h-8 rounded-xl object-cover shadow-sm" />
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <Button type="button" variant="outline" disabled={loading} className="w-full mb-6 font-medium h-12" onClick={onGoogleSignIn}>
                ...
                <form onSubmit={signInForm.handleSubmit(onSubmit)} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input type="email" {...signInForm.register("email")} className="h-12" placeholder="m@example.com" />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input type="password" {...signInForm.register("password")} className="h-12" placeholder="••••••••" />
                  ...
                  <Button type="submit" disabled={loading} className="w-full h-12 font-medium mt-2">
